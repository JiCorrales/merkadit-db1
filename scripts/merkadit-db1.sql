...
CREATE TABLE IF NOT EXISTS `Merkadit`.`mk_logs` (
  ...
  INDEX `fk_mk_logs_mk_users1_idx` (`userID` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_logs_logLevels1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_mk_logs_mk_users1`
    FOREIGN KEY (`userID`)
    REFERENCES `Merkadit`.`mk_users` (`userID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `Merkadit`.`mk_kiosksPerFloors`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Merkadit`.`mk_kiosksPerFloors` (
  `kioskID` INT NOT NULL,
  `floorID` INT NOT NULL,
  `deleted` BIT NOT NULL DEFAULT 0,
  `postTime` DATETIME NOT NULL,
  PRIMARY KEY (`kioskID`, `floorID`),
  INDEX `fk_mk_locals_has_mk_floors_mk_floors1_idx` (`floorID` ASC) VISIBLE,
  INDEX `fk_mk_kiosksPerFloors_mk_kiosks1_idx` (`kioskID` ASC) VISIBLE,
  CONSTRAINT `fk_mk_locals_has_mk_floors_mk_floors1`
    FOREIGN KEY (`floorID`)
    REFERENCES `Merkadit`.`mk_floors` (`floorID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_mk_kiosksPerFloors_mk_kiosks1`
    FOREIGN KEY (`kioskID`)
    REFERENCES `Merkadit`.`mk_kiosks` (`kioskID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `Merkadit`.`mk_contractsPerKiosks` (
  ...
  `deleted` BIT NOT NULL DEFAULT 1,
  PRIMARY KEY (`contractID`, `kioskID`),
...
-- -----------------------------------------------------
-- Table `Merkadit`.`mk_transactionTypes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Merkadit`.`mk_transactionTypes` (
...
CREATE TABLE IF NOT EXISTS `Merkadit`.`mk_transactions` (
  ...
  CONSTRAINT `fk_mk_transactions_mk_transactionType1`
    ...
    REFERENCES `Merkadit`.`mk_transactionTypes` (`transactionTypeID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `Merkadit`.`mk_marketsPerBuilding`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Merkadit`.`mk_marketsPerBuilding` (
  `marketID` INT NOT NULL,
  `buildingID` INT NOT NULL,
  `deleted` BIT NOT NULL DEFAULT 1,
  `postTime` DATETIME NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Merkadit`.`mk_marketContactInfo` (
  ...
  INDEX `fk_mk_marketContactInfo_mk_markets1_idx` (`marketID` ASC) VISIBLE,
  CONSTRAINT `fk_mk_marketContactInfo_mk_contactInfoType1`
    FOREIGN KEY (`contactInfoTypeID`)
    REFERENCES `Merkadit`.`mk_contactInfoType` (`contactInfoTypeID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_mk_marketContactInfo_mk_markets1`
    FOREIGN KEY (`marketID`)
    REFERENCES `Merkadit`.`mk_markets` (`marketID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
